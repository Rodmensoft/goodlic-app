...
class _PaymentJazzCashViewState extends State<PaymentJazzCashView>
                                  ...
                                  children: [
                                    ...
                                    TextFormField(
                                      ...
                                      style: const TextStyle(
                                          ...
                                          fontWeight: FontWeight.w400,
                                          color: Color(0xff757575)),
                                      controller: _bookAppointmentLogicController
                                          .paymentAccountNumberTextController,
                                      keyboardType: TextInputType.number,
                                      decoration: const InputDecoration(
                                        isDense: true,
                ...
                onTap: () {
                  ...
                  if (_paymentFormKey.currentState!.validate()) {
                    ...
                    postMethod(
                        ...
                        {
                          'token': '123',
                          'mobile_no': _bookAppointmentLogicController
                              .paymentAccountNumberTextController.text,
                          'bookAppointmentId': _bookAppointmentLogicController
                              .bookAppointmentModel.data!.appointmentNo,
                          'cnic': _bookAppointmentLogicController
                              .jazzCashCnicTextController.text,
                          'amount': _bookAppointmentLogicController
