...
getGenericDataRepo(
  ...
  if (responseCheck) {
    ...
    if (Get.find<CreateProfileLogic>().mentorProfileGenericDataModel.status ==
      ...
      for (var element in Get.find<CreateProfileLogic>()
...
getCitiesRepo(
  ...
  if (responseCheck) {
    ...
    if (Get.find<CreateProfileLogic>().citiesByIdModel.status == true) {
      ...
      for (var element
          in Get.find<CreateProfileLogic>().citiesByIdModel.data!.cities!) {
...
getChildCategoryRepo(
  ...
  if (responseCheck) {
    Get.find<CreateProfileLogic>().getChildCategoriesModel =
        GetCategoriesModel.fromJson(response);
    if (Get.find<CreateProfileLogic>().getChildCategoriesModel.status == true) {
      if (Get.find<CreateProfileLogic>()
        ...
        Get.find<CreateProfileLogic>().updateAllSubCategoriesList(
            Get.find<CreateProfileLogic>().getChildCategoriesModel);
        Get.find<CreateProfileLogic>()
            .updateAllSubCategoriesForDropDownList(tempList);
      }
