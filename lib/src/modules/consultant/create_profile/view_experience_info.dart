...
class _ExperienceInfoViewState extends State<ExperienceInfoView> {
        ...
        builder: (_createProfileLogic) => ModalProgressHUD(
          ...
          child: Scaffold(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: LanguageConstant.companyName.tr.capitalizeFirst,
                          ...
                          child: Padding(
                            ...
                            child: Theme(
                              ...
                              child: DateTimeField(
                                ...
                                style: state.textFieldTextStyle,
                                decoration: InputDecoration(
                                    hintText: LanguageConstant.from.tr.capitalizeFirst,
                                    hintStyle: state.hintTextStyle,
                                ...
                                initialValue: _createProfileLogic.selectedCompanyFromDate,
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    _createProfileLogic.selectedCompanyFromDate = value;
                                  });
                                },
                              ),
                            ),
                          ...
                          child: Padding(
                            ...
                            child: Theme(
                              ...
                              child: DateTimeField(
                                ...
                                style: state.textFieldTextStyle,
                                decoration: InputDecoration(
                                    hintText: LanguageConstant.to.tr.capitalizeFirst,
                                    hintStyle: state.hintTextStyle,
                                    contentPadding: EdgeInsetsDirectional.fromSTEB(25.w, 15.h, 15.w, 15.h),
                                    fillColor: Colors.white,
                                    filled: true,
                                ...
                                initialValue: _createProfileLogic.selectedCompanyToDate,
                                format: DateFormat('dd-MM-yyyy'),
                                onShowPicker: (context, currentValue) async {
                                  final date = await showDatePicker(context: context, firstDate: DateTime(1900), initialDate: currentValue ?? DateTime.now(), lastDate: DateTime.now());
                                  if (date != null) {
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    _createProfileLogic.selectedCompanyToDate = value;
                                  });
                                },
                              ),
                            ),
                      ...
                      child: Center(
                        child: InkWell(
                          onTap: () {
                            ...
                            if (_experienceInfoFormKey.currentState!.validate()) {
                                ...
                                showDialog(
                                    ...
                                    builder: (BuildContext context) {
                                      return CustomDialogBox(
                                        ...
                                        descriptions: LanguageConstant.uploadYourExperienceCertificate.tr,
                    ...
                    Padding(
                        ...
                        child: Wrap(
                          children: List.generate(_createProfileLogic.forDisplayExperienceList!.length, (index) {
                            return Padding(
                                      ...
                                      children: [
                                          ...
                                          children: [
                                            ...
                                            InkWell(
                                              onTap: () {
                                                ...
                                                postMethod(
                                                    context, mentorExperienceInfoDeleteUrl, {'token': '123', 'id': _createProfileLogic.forDisplayExperienceList![index].id}, true, deleteEducationRepo);
                                                _createProfileLogic.forDisplayExperienceList!.removeAt(index);
                                                setState(() {});
                                              },
                                              child: Padding(
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            _createProfileLogic.forDisplayExperienceList![index].imagePath != null
                                                ? Padding(
              ...
              bottomNavigationBar: Padding(
                ...
                child: InkWell(
                    onTap: () {
                      if (_createProfileLogic.forDisplayExperienceList!.isNotEmpty) {
                        setState(() {
                          _createProfileLogic.stepperScrollController.animateTo(
                            _createProfileLogic.stepperScrollController.position.maxScrollExtent,
                        ...
                        showDialog(
                            ...
                            builder: (BuildContext context) {
                              return CustomDialogBox(
                                ...
                                titleColor: customDialogErrorColor,
                                descriptions: LanguageConstant.addWorkExperiencePlease.tr,
                                text: LanguageConstant.ok.tr,
                                functionCall: () {
                                  Navigator.pop(context);
                                },
  ...
  _mentorExperienceInfoRepo(File? file1) async {
    dio_instance.FormData formData = dio_instance.FormData.fromMap(<String, dynamic>{
      ...
      'from': DateFormat('yyyy-MM-dd').format(Get.find<CreateProfileLogic>().selectedCompanyFromDate!).toString(),
      'to': DateFormat('yyyy-MM-dd').format(Get.find<CreateProfileLogic>().selectedCompanyToDate!).toString(),
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Get.find<CreateProfileLogic>().experienceInfoPostModel = ExperienceInfoPostModel.fromJson(response.data);
        if (Get.find<CreateProfileLogic>().experienceInfoPostModel.status == true) {
          Get.find<CreateProfileLogic>().updateForDisplayExperienceList(Get.find<CreateProfileLogic>().experienceInfoPostModel.data!.experience);
