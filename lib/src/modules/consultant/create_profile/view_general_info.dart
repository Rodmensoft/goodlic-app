...
class _GeneralInfoViewState extends State<GeneralInfoView> {
                      ...
                      SingleChildScrollView(
                        ...
                        child: Column(
                          ...
                          children: [
                            ///---picture
                            profileImage == null
                                ? _createProfileLogic.generalInfoPostModel.data == null
                                    ? InkWell(
                                        onTap: () {
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                controller: _createProfileLogic.firstNameController,
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                inputFormatters: [FilteringTextInputFormatter.allow(RegExp("[a-z A-Z ]"))],
                                style: state.textFieldTextStyle,
                                controller: _createProfileLogic.lastNameController,
                                keyboardType: TextInputType.name,
                                decoration: InputDecoration(
                                  contentPadding: EdgeInsetsDirectional.fromSTEB(25.w, 15.h, 25.w, 15.h),
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                inputFormatters: [FilteringTextInputFormatter.allow(RegExp("[a-z A-Z ]"))],
                                style: state.textFieldTextStyle,
                                controller: _createProfileLogic.fatherNameController,
                                keyboardType: TextInputType.name,
                                decoration: InputDecoration(
                                  contentPadding: EdgeInsetsDirectional.fromSTEB(25.w, 15.h, 25.w, 15.h),
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                style: state.textFieldTextStyle,
                                controller: _createProfileLogic.addressController,
                                    ...
                                    child: ButtonTheme(
                                      ...
                                      child: DropdownButtonHideUnderline(
                                        child: DropdownButtonFormField<String>(
                                          ...
                                          iconSize: 25,
                                          value: _createProfileLogic.selectedGender,
                                          items: _createProfileLogic.genderDropDownList.map<DropdownMenuItem<String>>((String value) {
                                          ...
                                          onChanged: (String? value) {
                                            setState(() {
                                              _createProfileLogic.selectedGender = value;
                                            });
                                          },
                                          validator: (String? value) {
                                            if (value == null) {
                                    ...
                                    child: ButtonTheme(
                                      ...
                                      child: DropdownButtonHideUnderline(
                                        child: DropdownButtonFormField<String>(
                                          ...
                                          icon: const Icon(Icons.keyboard_arrow_down),
                                          iconSize: 25,
                                          value: _createProfileLogic.selectedReligion,
                                          items: _createProfileLogic.religionDropDownList.map<DropdownMenuItem<String>>((String value) {
                                            return DropdownMenuItem<String>(
                                              value: value,
                                              child: Text(
                                                value,
                                          ...
                                          onChanged: (String? value) {
                                            setState(() {
                                              _createProfileLogic.selectedReligion = value;
                                            });
                                          },
                                          validator: (String? value) {
                                            if (value == null) {
                                  ...
                                  child: Padding(
                                    ...
                                    child: Theme(
                                      ...
                                      child: DateTimeField(
                                        ...
                                        initialValue: _createProfileLogic.selectedDob,
                                        ...
                                        onChanged: (value) {
                                          setState(() {
                                            _createProfileLogic.selectedDob = value;
                                          });
                                        },
                                      ),
                                    ),
                                    ...
                                    child: ButtonTheme(
                                      ...
                                      child: DropdownButtonHideUnderline(
                                        child: DropdownButtonFormField<String>(
                                          ...
                                          icon: const Icon(Icons.keyboard_arrow_down),
                                          iconSize: 25,
                                          value: _createProfileLogic.selectedOccupation,
                                          items: _createProfileLogic.occupationDropDownList.map<DropdownMenuItem<String>>((String value) {
                                            return DropdownMenuItem<String>(
                                              value: value,
                                              child: Text(
                                                value,
                                          ...
                                          onChanged: (String? value) {
                                            setState(() {
                                              _createProfileLogic.selectedOccupation = value;
                                            });
                                          },
                                          validator: (String? value) {
                                            if (value == null) {
                    ...
                    child: InkWell(
                        onTap: () {
                          ...
                          if (_generalInfoFormKey.currentState!.validate()) {
                            ...
                            } else if (_createProfileLogic.generalInfoPostModel.data != null && profileImage == null) {
                              Get.find<GeneralController>().updateFormLoaderController(true);
                              postMethod(
                                  context,
                                  mentorGeneralInfoPostUrl,
                                  {
                                    ...
                                    'first_name': _createProfileLogic.firstNameController.text,
                                    ...
                                    'religion': _createProfileLogic.selectedReligion,
                                    'dob': DateFormat('yyyy-MM-dd').format(_createProfileLogic.selectedDob!).toString(),
                                    'occupation': _createProfileLogic
                                        .mentorProfileGenericDataModel.data!.occupations![_createProfileLogic.occupationDropDownList.indexOf(_createProfileLogic.selectedOccupation!)].id,
                                    'country':
  ...
  mentorGeneralInfoRepo(File? file1) async {
    dio_instance.FormData formData = dio_instance.FormData.fromMap(<String, dynamic>{
      ...
      'dob': DateFormat('yyyy-MM-dd').format(Get.find<CreateProfileLogic>().selectedDob!).toString(),
      'occupation': Get.find<CreateProfileLogic>()
          .mentorProfileGenericDataModel
          .data!
          .occupations![Get.find<CreateProfileLogic>().occupationDropDownList.indexOf(Get.find<CreateProfileLogic>().selectedOccupation!)]
          .id,
      'country':
    ...
    try {
      ...
      if (response.statusCode == 200) {
        Get.find<CreateProfileLogic>().generalInfoPostModel = GeneralInfoPostModel.fromJson(response.data);
          ...
          showDialog(
              ...
              builder: (BuildContext context) {
                return CustomDialogBox(
                  ...
                  titleColor: customDialogErrorColor,
                  descriptions: '${Get.find<CreateProfileLogic>().generalInfoPostModel.msg}',
                  text: LanguageConstant.ok.tr,
                  functionCall: () {
                    Navigator.pop(context);
                  },
